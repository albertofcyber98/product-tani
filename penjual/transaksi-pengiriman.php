...
FROM data_transaksi INNER JOIN data_pembeli ON data_transaksi.username_pembeli=data_pembeli.username WHERE data_transaksi.username_penjual='$username' AND data_transaksi.status='Pengiriman'");
?>
<!doctype html>
<html lang="en">
