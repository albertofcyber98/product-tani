...
FROM data_transaksi INNER JOIN data_pembeli ON data_transaksi.username_pembeli=data_pembeli.username WHERE data_transaksi.username_penjual='$username' AND data_transaksi.status='Verifikasi'");
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="row">
        <div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
            ...
            <?php
            $page = 5;
            $title_nav = 'Transaksi Verifikasi';
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $transasi['id_transaksi']; ?>">Pengiriman</button>
                                                </td>
                                                <!-- Modal Verif -->
            ...
            echo '
                    <script type="text/javascript">
                        swal({
                            ...
                            if(isConfirm){
                                window.location.replace("transaksi-verif.php");
                            }else{
